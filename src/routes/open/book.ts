...
const format = (resultRow) => //TODO fix formatting maybe?
 ...
 * @apiGroup Books
 *
 * @apiParam {Number} book a unique book id.
...
bookRouter.post(
  ...
  (request: Request, response: Response) => {
      ...
      INSERT 
      INTO
      BOOKS(Book_id, Isbn13, Authors, Original_publication_year, Original_title, Title, Image_url, Small_image_url)
